...
# ------------------------------------------------------
BOT_TOKEN = getenv("BOT_TOKEN", "7245575969:AAHJePj-eYF050bfAV3K1MwMWVf-ztEY3Uc")
# -------------------------------------------------------
...
# ------------------------------------------------------------------------
# -------------------------------------------------------------------------
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/SANATANI_X_PFP")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/bcdx63.jpg"
)
PING_IMG_URL = getenv(
